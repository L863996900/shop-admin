      ...
      <el-card>
        ...
        <el-tabs :before-leave="beforeTabLeave" @tab-click="tabClicked" v-model="activeIndex" :tab-position="'left'">
          ...
          <el-tab-pane label="商品内容" name="4">
            ...
            <!--添加商品-->
            <el-button type="primary" size="small" @click="add" class="btnAdd">添加商品</el-button>
          </el-tab-pane>
        </el-tabs>
        </el-form>
      </el-card>
  ...
  methods: {
    ...
    add () {
      ...
      this.$refs.addFormRef.validate(async valid => {
        if (!valid) {
          return this.$message.error('请填写必要的商品参数项！')
        }
        // 执行添加的业务逻辑
